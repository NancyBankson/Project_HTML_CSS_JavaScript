...
The project was deployed and can be accessed at https://nancybankson.github.io/Project_HTML_CSS_JavaScript/.  At first deployment, only readme was showing.  I moved the html file to the root directory.  Hopefully, it will deploy correctly after pushing this readme.
